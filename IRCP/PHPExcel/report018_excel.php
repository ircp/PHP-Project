...
//	$processid = updateProcessLog($objectid, $processtype, $processstatus, $processid);
	...
	$header1 = "รายละเอียดการใช้บริการโทรศัพท์เคลื่อนที่ในโครงข่าย Partnership AWN ของบริษัท ".$NAME['MVNO'][$mvno]['NAME'];
	$header2 = "ประจำเดือน ".$monthdisplay." ".$selectyear;
	$title = "Traffic_Usage_Partnership";
	$filename = "Traffic_Usage_Partnership_".$NAME['MVNO'][$mvno]['NAME']."_".$selectyear.$selectmonth.".xls";
